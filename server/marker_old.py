...
parser.add_argument('--width', type=int, default=640, help='Frame width (default is 1280)')
parser.add_argument('--height', type=int, default=480, help='Frame height (default is 720)')
